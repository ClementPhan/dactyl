...
[SYMB] = LAYOUT_dactyl(
       ...
       KC_TRNS,    ALGR(KC_6),     ALGR(KC_7),     ALGR(KC_8),  LSFT(KC_EQL),        KC_TRNS,
       KC_TRNS,        KC_EQL,  ALGR(KC_LBRC),  ALGR(KC_QUOT),    LSFT(KC_8),        KC_NUBS,
       KC_TRNS,  ALGR(KC_EQL),  ALGR(KC_RBRC),  ALGR(KC_NUHS),    LSFT(KC_9),  LSFT(KC_NUBS),
       KC_TRNS,       KC_TRNS,        KC_TRNS,        KC_TRNS,       KC_TRNS,
                                                                                           KC_TRNS,  KC_TRNS,
                                                                                                     KC_TRNS,
                                                                                 KC_TRNS,  KC_TRNS,  KC_TRNS,
       // right hand   
                KC_TRNS,    KC_P7,    KC_P8,    KC_P9,  KC_PSLS,  KC_TRNS,
                KC_TRNS,    KC_P4,    KC_P5,    KC_P6,  KC_PAST,  KC_TRNS,
                KC_TRNS,    KC_P1,    KC_P2,    KC_P3,  KC_PMNS,  KC_TRNS,
                KC_TRNS,    KC_P0,  KC_PDOT,  KC_PENT,  KC_PPLS,  KC_TRNS,
                          KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,
      KC_TRNS,  KC_TRNS,
      KC_TRNS,
      KC_TRNS,  KC_TRNS,  KC_TRNS
...
[MDIA] = LAYOUT_dactyl(
       ...
       KC_TRNS,        KC_TRNS,     KC_TRNS,  ALGR(KC_E),     KC_TRNS,  KC_TRNS,
       KC_TRNS,  ALGR(KC_NUBS),  ALGR(KC_1),  ALGR(KC_2),  ALGR(KC_3),  KC_PGUP,
       KC_TRNS,        KC_TRNS,      KC_INS,     KC_HOME,      KC_END,  KC_PGDN,
       KC_TRNS,        KC_TRNS,     KC_TRNS,     KC_TRNS,     KC_TRNS,
                                                         KC_TRNS,  KC_TRNS,
                                                                   KC_TRNS,
                                               KC_TRNS,  KC_TRNS,  KC_TRNS,
